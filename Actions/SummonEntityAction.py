...
class SummonEntityAction(Action):
    def __init__(self, name, create_entity_function,rounds=0, description="", proc_chance=1, needs_target=False):
        super().__init__(name, rounds, description=description, proc_chance=proc_chance, needs_target=needs_target)
